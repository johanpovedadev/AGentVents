...
async function parseIntent(message) {
  ...
  try {
    ...
    const validTypes = ['crear_contacto', 'crear_deal', 'actualizar_deal', 'actualizar_contacto', 'generar_informe', 'publicar_post'];
